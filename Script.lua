...
if Status or Dev_Kek(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_Kek(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_Kek(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Kek(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Kek(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Kek(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
url = 'https://raw.githubusercontent.com/Kekkid/Kek/master/Script.lua'
...
url = 'https://raw.githubusercontent.com/Kekkid/Kek/master/Kek.lua'
file_path = 'Kek.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
...
if data.Ch_Member.Kek ~= true then
